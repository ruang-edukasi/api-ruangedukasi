...
module.exports = {
    getCourseDiscussions: async(req, res) => {
        try {
            ...
            console.error("Terjadi error saat melakukan diskusi kursus:", error);
    ...
    addDiscussionComment: async(req, res) => {
        try {
            ...
            console.error("Kesalahan saat menambahkan komentar diskusi:", error);
            res.status(500).json({ message: "Internal Server Error" });
        }
    },
    ...
    addReplyToComment: async(req, res) => {
        try {
            ...
            console.error("Kesalahan saat menambahkan balasan:", error);
            res.status(500).json({ message: "Internal Server Error" });
        }
    },
};